...
function App() {
  ...
  async function fetchTasks() {
    try {
      const response = await fetch("https://api.monapp.com/tasks");
  ...
  async function toggleTask(task) {
    try {
      const response = await fetch(`https://api.monapp.com/tasks/${task.id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  async function deleteTask(id) {
    try {
      const response = await fetch(`https://api.monapp.com/tasks/${id}`, { method: "DELETE" });
